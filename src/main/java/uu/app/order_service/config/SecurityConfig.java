...
// -- для Order Service 'package uu.app.order_service.config;'
// -- для User Service 'package uu.app.order_service.config;'
package uu.app.order_service.config;
// Імпортує:
// -- анотацію Bean
...
import uu.app.order_service.filter.JwtAuthenticationFilter;
